        ...
        VStack(alignment: .leading, spacing: 0) {
            HStack(spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 1) {
                    Text("GIM17").font(Theme.ui(15, .semibold)).foregroundStyle(Theme.text)
                    Text("детерминированное ядро").font(Theme.ui(9.5)).foregroundStyle(Theme.faint)
                }
            }
            ...
            HStack(alignment: .firstTextBaseline, spacing: 6) {
                ...
                Text(app.ready ? app.status : "запуск движка…")
