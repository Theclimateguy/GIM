...
2. `GIM_12/agent_states_gim13.csv`, but only if `GIM13_USE_EXPERIMENTAL_STATE=1`.
...
- explicit CLI or case value;
- else the first four-digit year found in the prompt;
- else `2026`.
