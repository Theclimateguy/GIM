...
# Resolved via paths.DATA_ROOT so the packaged-data relocation applies here too.
from .paths import DATA_ROOT as _DATA_ROOT

GEOJSON = str(_DATA_ROOT / "world_countries.geojson")
STATE = str(_DATA_ROOT / "agent_states_operational.csv")
