...
DEBT_CRISIS_PERSIST_GDP_MULT = 0.97  # [PRIOR]
DEBT_CRISIS_PERSIST_TRUST_HIT = 0.03  # [PRIOR]
DEBT_CRISIS_PERSIST_TENSION_HIT = 0.02  # [PRIOR]
DEBT_CRISIS_EXIT_THRESHOLD = 0.70  # [PRIOR]
DEBT_CRISIS_EXIT_RATE = 0.08  # [PRIOR]
DEBT_CRISIS_MAX_YEARS = 8  # [PRIOR]
REGIME_CRISIS_PERSIST_GDP_MULT = 0.96  # [PRIOR]
REGIME_CRISIS_PERSIST_CAPITAL_MULT = 0.975  # [PRIOR]
REGIME_CRISIS_MAX_YEARS = 5  # [PRIOR]
...
CALIBRATION_STATUS = {
    ...
    "REGIME_CRISIS_PERSIST_GDP_MULT": "prior",
    "REGIME_CRISIS_PERSIST_CAPITAL_MULT": "prior",
    "REGIME_CRISIS_MAX_YEARS": "prior",
    "DEBT_CRISIS_DEBT_THRESHOLD": "prior",
    "DEBT_CRISIS_PERSIST_GDP_MULT": "prior",
    "DEBT_CRISIS_PERSIST_TRUST_HIT": "prior",
    "DEBT_CRISIS_PERSIST_TENSION_HIT": "prior",
    "DEBT_CRISIS_EXIT_THRESHOLD": "prior",
    "DEBT_CRISIS_EXIT_RATE": "prior",
    "DEBT_CRISIS_MAX_YEARS": "prior",
