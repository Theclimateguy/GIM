...
LLM_POLICY_PROMPT_TEMPLATE = (
    ...
    "- neighbors (external_actors['neighbors']): trade_intensity, trust,\n"
    "  conflict_level, gdp, military_power, alliance_block.\n\n"
    ...
    "- Foreign : trade deals, sanctions, security_actions.\n"
