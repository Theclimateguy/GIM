...
- Global CO2:
  ...
  - artifact binding: `EMISSIONS_SCALE` comes from [agent_states_gim13.artifacts.json](/Users/theclimateguy/Documents/jupyter_lab/GIM_14/misc/data/agent_states_gim13.artifacts.json), not a free knob
- Temperature:
...
Their active values must come from [agent_states_gim13.artifacts.json](/Users/theclimateguy/Documents/jupyter_lab/GIM_14/misc/data/agent_states_gim13.artifacts.json), and should only change through the refresh path, not by hand-editing [calibration_params.py](/Users/theclimateguy/Documents/jupyter_lab/GIM_14/gim/core/calibration_params.py).
