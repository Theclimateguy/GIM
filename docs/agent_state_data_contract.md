...
In `GIM18`, it is the working contract for both the compact runtime state and the larger
operational state build.

> **Canonical state (single source of truth).** All blocks — the GIM18 engine, the `gim2`
