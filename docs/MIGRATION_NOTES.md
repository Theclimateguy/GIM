# GIM15 Migration Notes

This document records the move from the older split workspace into the unified `GIM15`
repository that is now the active development base.

## Migration Principles

- no files were removed from the source repository
- the new repository was created side-by-side as `/Users/theclimateguy/Documents/jupyter_lab/GIM15`
...
- updated the CLI display name and default state CSV location for `GIM15`
...
- removed documentation snapshots from the public docs surface and kept only active `GIM15` docs
...
The older versioned folders remain useful as provenance, but `GIM15` is now the intended
working repository.
