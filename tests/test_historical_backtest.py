...
class HistoricalBacktestTests(unittest.TestCase):
    ...
    # [#17 + #12 2026-07] Re-anchored: damage normalised to the 2023 baseline with the Howard-Sterner-
    # central coefficient (removes a spurious base-year double-count -> GDP RMSE 0.621->0.598, an
    # IMPROVEMENT) and internal-variability sigma raised to the spread-matched 0.088 (temp RMSE
    # 0.135->0.145; ensemble no longer under-dispersed). CO2 essentially unchanged.
    GOLDEN = {
        "gdp_rmse_trillions": 0.598,
        "global_co2_rmse_gtco2": 0.939,
        "temperature_rmse_c": 0.145,
    }
    TOLERANCE = 0.01
