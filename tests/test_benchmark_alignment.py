...
class SCCAlignmentTests(unittest.TestCase):
    ...
    def test_gim_at_modern_discounting_reproduces_epa_rff_central(self):
        # The headline objectivity result: at the RFF-SP/EPA near-term-2% scheme, GIM's
        # 200-yr SCC lands in the modern-consensus band (~$150-230), i.e. ~$185-190.
        rep = scc_alignment_report(horizons=(200,))
        scc200 = rep["gim_modern_2pct"][200]
        self.assertTrue(150.0 <= scc200 <= 230.0, scc200)
