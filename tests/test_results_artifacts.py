...
class ResultsArtifactsTests(unittest.TestCase):
    ...
    def test_credit_map_script_finds_latest_world_log_in_nested_results_dirs(self) -> None:
        with TemporaryDirectory() as tmp_dir:
            ...
            older_world = older_dir / "GIM17_2026-03-15_19-00-00_t0-t5.csv"
            newer_world = newer_dir / "GIM17_2026-03-15_20-00-00_t0-t5.csv"
            ignored_actions = newer_dir / "GIM17_2026-03-15_20-00-00_actions.csv"
            ignored_institutions = newer_dir / "GIM17_2026-03-15_20-00-00_institutions.csv"
