...
cost of carbon under DICE inputs (about \$30 per ton of carbon dioxide at a 100-year horizon versus
DICE's \$31, rising to about \$37 over a multi-century horizon as the long-run damage tail
integrates), so the higher headline cost of carbon follows entirely from the higher,
...
Cost of carbon & EPA-2023, RFF-SP & published cross-check; DICE engine reproduction & ${\approx}\$140$/t$\,\mathrm{CO_2}$ (range $140$--$380$); recovers DICE-2016R2 (\$30 at 100\,y; target \$31) under DICE inputs \\
...
and the regime-collapse GDP multiplier), while the lower-ranked parameters sit close together and may
exchange places). Social tension, by contrast, is almost insensitive to these physico-economic
