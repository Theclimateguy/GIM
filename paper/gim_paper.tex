...
emissions; for product the top four are stable (capital depreciation, the damage coefficient, energy intensity,
and the regime-collapse GDP multiplier), while the fifth alternates between the capital--energy
substitution elasticity and the equilibrium climate sensitivity). Social tension, by contrast, is almost insensitive to these physico-economic
...
range (roughly the $5$--$95$th percentile of the prior), and the main source. The full set of $33$
key and $305$ total parameters with distributions and justifications is available in the repository
