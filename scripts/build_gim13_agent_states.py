...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "/Users/theclimateguy/Documents/jupyter_lab/GIM18/data/agent_states_operational.csv"
        ),
    )
    parser.add_argument(
        "--data-root",
        type=Path,
        default=Path("/Users/theclimateguy/Documents/jupyter_lab/GIM18/data/agent_state_pipeline"),
    )
