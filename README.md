...
`GIM17` is the active repository for the yearly geopolitical-economy simulator and its scenario/game tooling.
...
- the local analytical workspace UI (`gim/ui_server.py`, `ui_prototype/gim17_dashboard_prototype.html`)
...
- `gim/ui_server.py`
- `ui_prototype/gim17_dashboard_prototype.html`
...
```bash
RUN_LLM=1 DEEPSEEK_API_KEY=... ./scripts/run_validation_package_gim17.sh
```
