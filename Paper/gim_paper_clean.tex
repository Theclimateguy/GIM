...
Equation~\eqref{eq:prod} as written is the Cobb--Douglas limit; the production core actually
computed is the nested form, of which \eqref{eq:prod} is the exact base-point reduction. Capital and energy form an inner CES composite that is then combined with
