...
def fig2():
    ...
    current = [0.60, 0.94, 0.145]   # [18.1.0] golden (damage normalised to 2023 base; sigma/rho re-derived)
    baseline = [0.60, 1.74, 0.144]  # Cobb-Douglas core, re-derived on 18.1.0 (same harness)
