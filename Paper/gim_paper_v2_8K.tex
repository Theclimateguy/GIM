...
and $1.078$ at 2026, 2036, and 2046: essentially stationary along the trajectory. About 70
...
divergence. The one persistent direction is social: raising every country's tension by $0.01$
...
\caption{The tail census (1,002 scripted playthroughs, 2023--2050). \emph{(a)}~Outcome
composition by policy archetype: no doctrine dominates and each dies of its characteristic
cause. \emph{(b)}~Timing of failures: 77\,\% of losses land in 2040--2045 as slow accumulators
come due. Production telemetry (200 completed human runs, 28.5\,\% survival, 90\,\% of losses
after 2040) reproduces the shape with a broader loss spectrum.}
\label{fig:game}
\end{figure}
