% =====================================================================================
%  GIM v20.1.1 -- model description manuscript
...
%  Zenodo: the paper cites the CONCEPT DOI 10.5281/zenodo.21575176, which represents all
%  versions and always resolves to the latest. The release these results were produced from
%  is tagged v20.1.1 in the repository and is the deposit that DOI resolved to on publication.
% =====================================================================================
...
% Every macro below was regenerated on 2026-08-27 by the harness
...
\title{\vspace{-1.5em}\textbf{GIM v20.1.1: a closed economy--climate--society world model
...
\Version{} on Zenodo at \url{https://doi.org/10.5281/zenodo.21575176}
\citep{theclimateguy2026gim}. That DOI represents all versions of the deposit and always
resolves to the latest, and it is the record we ask readers to cite. The results in this paper
were produced by the release tagged \texttt{\Version} in the repository, which is the version
that DOI resolved to at publication; a reader who needs that exact state rather than the
current one can select it from the version list on the Zenodo record. The archive is the
citable record; the development repository at
\url{https://github.com/Theclimateguy/GIM} (tag \texttt{\Version}) is a convenience mirror and
is \emph{not} the archival copy. All code and configuration are released under the Apache
License 2.0, an OSI-approved licence. The engine is unchanged from v20.1.0, which it reproduces to the bit on every headline
metric; v20.1.1 replaces the superseded manuscript draft and withdraws the licensed Hofstede
multi-country panels from the distribution. The archive contains the model source; the user manual
